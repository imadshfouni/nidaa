  ...
  return (
    <div className={`flex flex-wrap gap-3 ${className}`}>
      <a
        ...
        className="flex min-w-[148px] items-center gap-3 rounded-xl border border-border bg-white/5 px-4 py-2.5 backdrop-blur-sm transition hover:border-primary/30 hover:bg-white/8"
      >
        ...
        <div className="flex flex-col leading-tight">
          ...
          <span className="text-[13px] font-semibold text-ink">App Store</span>
        </div>
      </a>
      <a
        ...
        className="flex min-w-[148px] items-center gap-3 rounded-xl border border-border bg-white/5 px-4 py-2.5 backdrop-blur-sm transition hover:border-primary/30 hover:bg-white/8"
      >
        <img src="/playstore.png" alt="" className="h-6 w-6 object-contain" aria-hidden="true" />
        <div className="flex flex-col leading-tight">
          <span className="text-[10px] text-muted">Get it on</span>
          <span className="text-[13px] font-semibold text-ink">Google Play</span>
        </div>
      </a>
    </div>
  )
